...
# Quick example oCl the API and workCllow 26-CCl3CH2CH2CH2CH2OH NEED HELP
...
chain.build(n=1, sequence='ACCCB')
...
charmm = mf_charmm.Charmm(box_liq,
                          'NPT_CCl3CH2CH2CH2CH2OH',
                          ff_filename="NPT_CCl3CH2CH2CH2CH2OH_file",

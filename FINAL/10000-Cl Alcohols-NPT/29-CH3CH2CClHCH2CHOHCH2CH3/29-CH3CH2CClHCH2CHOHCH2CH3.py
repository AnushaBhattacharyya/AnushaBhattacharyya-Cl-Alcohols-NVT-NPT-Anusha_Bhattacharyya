...
# Quick example oCl the API and workCllow 29-CH3CH2CClHCH2CHOHCH2CH3
...
chain.add_monomer(compound=comp3,
                  ...
                  separation=.3,
                  replace=True)
chain.build(n=1, sequence='CCACBCC')
...
charmm = mf_charmm.Charmm(box_liq,
                          'NPT_CH3CH2CClHCH2CHOHCH2CH3',
                          ff_filename="NPT_CH3CH2CClHCH2CHOHCH2CH3_file",

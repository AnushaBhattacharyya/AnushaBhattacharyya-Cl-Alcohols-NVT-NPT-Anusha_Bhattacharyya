...
# Quick example oCl the API and workCllow 25-CCl3CCl2CH2CH2CH2OH NEED HELP
...
chain.build(n=1, sequence='AACCB')
...
charmm = mf_charmm.Charmm(box_liq,
                          'NPT_CCl3CCl2CH2CH2CH2OH',
                          ff_filename="NPT_CCl3CCl2CH2CH2CH2OH_file",

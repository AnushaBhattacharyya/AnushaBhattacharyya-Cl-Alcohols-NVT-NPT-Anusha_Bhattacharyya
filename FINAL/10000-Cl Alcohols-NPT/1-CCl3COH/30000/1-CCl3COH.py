...
# Quick example oCl the API and workCllow 1-CCl3COH
...
"""chain.add_end_groups(mb.load('',smiles=True), # Capping oClCl this polymer with Carboxylic acid groups
#                     index=1,
#                     separation=0.1, label="tail" , duplicate = True)"""
chain.build(n=1, sequence='AB')

...
# Quick example oCl the API and workCllow 31-CH3CCl2CH2CH2CH2OH
...
chain.add_monomer(compound=comp3,
                  ...
                  separation=.15,
                  replace=True)
chain.build(n=1, sequence='CCCAB')
...
charmm = mf_charmm.Charmm(box_liq,
                          'NPT_CH3CCl2CH2CH2CH2OH',
                          ff_filename="NPT_CH3CCl2CH2CH2CH2OH_file",

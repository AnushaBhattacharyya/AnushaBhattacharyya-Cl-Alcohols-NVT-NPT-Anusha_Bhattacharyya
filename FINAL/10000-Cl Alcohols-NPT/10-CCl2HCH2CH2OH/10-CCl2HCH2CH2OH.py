...
# Quick example oCl the API and workCllow 10-CCl2HCH2CH2OH
comp1 = mb.load('C', smiles=True) # mBuild compound oCl the monomer unit
comp2 = mb.load('C(Cl)(Cl)', smiles=True) # mBuild compound oCl the monomer unit
comp3 = mb.load('CO', smiles=True) # mBuild compound oCl the monomer unit
chain = Polymer()
...
charmm = mf_charmm.Charmm(box_liq,
                          'NPT_CCl2HCH2CH2OH',
                          ff_filename="NPT_CCl2HCH2CH2OH_file",
